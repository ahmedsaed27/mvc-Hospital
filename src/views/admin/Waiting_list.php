		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Wating List</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table table-bordered table-dark table-hover">
                          ...
                          <th><?= $user['Serial_Number']?></th>
							...
							<th><?= $user['address']?></th>
						    <th><?= $user['sendby']?></th>
							<th><?= $user['arrivalTime']?></th>
							<th><?= $user['roomNum']?></th>
							<th><?= $user['Notics']?></th>
							<th><a href="delatePatient_fromWatingList/<?= $user['id']?>">delate</a></th>
							<th><a href="edit_watingList/<?= $user['id']?>">update</a></th>

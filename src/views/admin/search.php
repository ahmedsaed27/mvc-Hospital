                            ...
                            <div class="col-md-7">
                                ...
                                <form action="<?= url('admin/search') ?>" method="post">
                                    <div class="input-group mb-3">
                                        ...
                                        <button type="submit" class="btn btn-primary but">Search</button>
                                    </div>
                                </form>
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <table class="table table-bordered">
                           ...
                           <?php if(isset($_POST['search']) && !empty($pationt)): ?> 
                            
                           <?  foreach($pationt as $pationt):   ?>
                            <tbody>
						    <tr>
						      <th ><?= $pationt['Serial_Number'] ?></th>
						      <td><?= $pationt['date'] ?></td>
						      <td><?= $pationt['name'] ?></td>
							  <td><?= $pationt['age'] ?></td>
							  <td><?= $pationt['job'] ?></td>
							  <td><?= $pationt['address'] ?></td>
							  <td><?= $pationt['sendby'] ?></td>
							  <td><?= $pationt['arrivalTime'] ?></td>
							  <td><?= $pationt['roomNum'] ?></td>
							  <td><?= $pationt['Notics'] ?> </td>
						    </tr>
						  </tbody>
